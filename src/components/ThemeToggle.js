...
export default function ThemeToggle() {
    ...
    const buttonClass = (theme) => {
        ...
        return `
            ...
            ${isSelected ? 'bg-[var(--main)] dark:bg-[var(--main)] text-[#f5f5f7]' : 'pointer hover:bg-[var(--accent)]'}
        `;
    };
    ...
    return (
        <div className="flex flex-col items-start gap-2 text-xs">
            <div className="flex flex-row border border-solid border-[var(--main)] rounded-full p-[2px] space-x-1">
