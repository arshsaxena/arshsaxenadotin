...
export const webProjectsBase = {
	...
	vinhance: {
		...
		techStack: ['JavaScript', 'HTML', 'CSS', 'Chromium'],
		target: '_blank',
	},
	gitsort: {
		label: 'GitSort',
		...
		desc2: 'Quickly sort GitHub repository files and folders by their last commit date. Features a native UI, local preference memory, and absolute date toggles. Zero setup, zero tokens, 100% local. Download for Chromium and Firefox.',
		href: 'https://github.com/GitSort-Dev',
		buttonLabel: 'Open Source',
		icon: '/made-by-arsh/web-projects/icons/gitsort.webp',
		img: '/made-by-arsh/web-projects/imgs/gitsort.webp',
		techStack: ['JavaScript', 'HTML', 'CSS', 'Chromium', 'Firefox'],
		target: '_blank',
	},
	nptelcompanion: {
