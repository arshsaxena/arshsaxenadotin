	...
	return (
		<>
			<div className="m-auto max-w-[980px]">
				<section className="text-md mx-5 my-10 rounded-[25px] border-[1px] border-[var(--border-default)] bg-[var(--surface)] p-5 pb-6 pt-10 md:p-0 md:text-[16px] md:dark:border-[var(--border-default)]">
					<AnimatedImgs />
				</section>
				<section className="text-md mx-5 mb-10 rounded-[25px] md:text-[16px] md:dark:border-[var(--border-default)]">
					<MadeByArshSection />
				</section>
			</div>
		</>
